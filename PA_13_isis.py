...
### Hier Funktion zum Extrahieren der Kanten
...
def generateTopEdges(partialMapsEdges):
    ...
    ### Hier die Koordinaten-Verschiebung und 
    ### Sortierung der Knoten innerhalb der Kanten einfuegen
